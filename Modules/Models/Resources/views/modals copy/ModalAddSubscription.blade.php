                ...
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                          ...
                          {{Form::number('sub_duration','',['class'=>'form-control', 'required', 'id' => 'sub_duration', 'placeholder' => 'Enter subscription duration'])}}
                        </div>
                      </div>
                    <div class="col-sm-4">
                      <div class="form-group">
                        <label>Payment Amount</label>
                        {{Form::number('paid_amount','',['class'=>'form-control', 'required', 'id' => 'paid_amount','placeholder' => 'Enter payment amount'])}}
                      </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="form-group">
                      ...
                      <div class="col-sm-4">
                        <div class="form-group">
                          ...
                          <div class="input-group">
                            ...
                            <input type="text" class="form-control" id="sub_start_date" name="sub_start_date" data-inputmask-alias="datetime" data-inputmask-inputformat="yyyy-mm-dd" data-mask>
                          </div>
                        </div>
                      </div>
                      <div class="col-sm-4">
                        <div class="form-group">
                          ...
                          <div class="input-group">
                            ...
                            <input type="text" class="form-control" id="sub_end_date" name="sub_end_date" data-inputmask-alias="datetime" data-inputmask-inputformat="yyyy-mm-dd" data-mask>
                          </div>
                        </div>
                      </div>
