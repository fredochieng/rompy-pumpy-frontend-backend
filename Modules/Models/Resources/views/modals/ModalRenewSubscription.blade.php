<div class="modal fade" id="ModalRenewSubscription_{{ $model->user_id }}">
    <div class="modal-dialog modal-xl">
        <form class="" method="POST" action="{{ route('subscription.renew') }}" role="form" autocomplete="off"
                ...
                <div class="modal-body">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    {{ Form::text('sub_start_dat', $subs1->sub_start_date, ['class' => 'form-control', 'id' => 'sub_start_dat', 'required']) }}
                                </div>
                            </div>
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    {{ Form::text('sub_end_dat', $subs1->sub_end_date, ['class' => 'form-control', 'id' => 'sub_start_dat', 'readonly', 'required']) }}
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    {{ Form::number('sub_duration1', '', ['class' => 'form-control', 'min' => '1', 'required', 'id' => 'sub_duration1', 'placeholder' => 'Enter renewal duration']) }}
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        {{-- <input type="text" class="form-control" value="{{ $subs1->sub_end_date }}"
                                            id="sub_start_date1" name="sub_start_date1" data-inputmask-alias="datetime"
                                            data-inputmask-inputformat="yyyy-mm-dd" data-mask> --}}

                                            {{ Form::text('sub_start_date1', $subs1->sub_end_date, ['class' => 'form-control', 'id' => 'sub_start_date1', 'required']) }}
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        {{-- <input type="text" class="form-control" id="sub_end_date1"
                                            name="sub_end_date1" data-inputmask-alias="datetime" readonly
                                            data-inputmask-inputformat="yyyy-mm-dd" data-mask> --}}
                                            {{ Form::text('sub_end_date1', '', ['class' => 'form-control', 'id' => 'sub_end_date1', 'required']) }}
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="modal-footer justify-content-between">
                            ...
                            <button type="submit" class="btn btn-info"><i class="fas fa-solid fa-sync"></i> Renew
                                Subscription</button>
                        </div>
                    </div>
        </form>
